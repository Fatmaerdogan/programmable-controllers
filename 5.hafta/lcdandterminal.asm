...
; C:\PBP\LCDAND~1.PBP      	00003	DEFINE HSER_BAUD 9600    'terminaldeki haberleþme hýzý
...
; C:\PBP\LCDAND~1.PBP      	00007	DEFINE LCD_DBIT 0                        '4-bit bus için data bit(0yada4) baslangiç
#define		LCD_DBIT		 0                        
...
#define		LCD_EBIT		 2                        
; C:\PBP\LCDAND~1.PBP      	00012	DEFINE LCD_BITS 8                             'PortD nin 8 biti veri transferi için kullanildi
#define		LCD_BITS		 8                             
...
; C:\PBP\LCDAND~1.PBP      	00013	TRISE=%000                                       'Aslinda PortE.1 direkt topraga çekilse olurdu ama 
	MOVE?CB	000h, TRISE
...
; C:\PBP\LCDAND~1.PBP      	00021	hserin[x] 'terminale girilen deðeri alýr
	HSERIN?B	_x

; C:\PBP\LCDAND~1.PBP      	00022	hserout[x] 'terminale yazdýr
	HSEROUT?B	_x
